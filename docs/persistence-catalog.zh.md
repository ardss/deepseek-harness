...
来源：[`packages/client/ui-workflow-run/src/client/workflow-projection.ts:39`](../packages/client/ui-workflow-run/src/client/workflow-projection.ts)
...
来源：[`packages/client/ui-workflow-run/src/client/workflow-projection.ts:37`](../packages/client/ui-workflow-run/src/client/workflow-projection.ts)
...
来源：[`packages/workflow/workflow-runs/src/projection.ts:128`](../packages/workflow/workflow-runs/src/projection.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| `artifacts` | 可选 | [`DynamicWorkflowRunArtifact[]`](#persistence-type-sha256-90154bd68a2e6ee0e4edbb2c5dc2dda75a16a17a355f0d93569ac053a549c59d) |
| `concurrency` | 可选 | [`ProjectionConcurrency`](#persistence-type-sha256-3faa1138c6628d35e59917c1bbfa4a2c9f6df57263abd0554fc31e34115ed2bc) |
| `currentPhase` | 可选 | `string` |
| `error` | 可选 | [`DynamicWorkflowRunError`](#persistence-type-sha256-7cdf07056e62f0cc08681f74e6f6f14d3b9cb69b49d5f50e2d11799571f79ee2) |
| `events` | 可选 | [`ProjectionEventLine[]`](#persistence-type-sha256-a868d71f167435e361014ba62ffaa8d9fea76bd6e7536ff11e1d65fdaed9b0a9) |
| `jobId` | 可选 | `string` |
| `label` | 必需 | `string` |
| `nodes` | 可选 | [`ProjectionNode[]`](#persistence-type-sha256-f549d548639819706e391f1c45017f6a5c818678cab65523f5541dee47f5e876) |
| `pendingQuestions` | 可选 | [`DynamicWorkflowRunPendingQuestion[]`](#persistence-type-sha256-803071654e6ee353b7d0ded83c8df402412ddd4e39f6dde70721194c38981200) |
| `phaseNames` | 可选 | [`string[]`](#persistence-type-sha256-93c33d9687613293f8c95d46c4d922fe9ceae83b84c384beff5c3315abe005f2) |
| `reports` | 可选 | [`DynamicWorkflowRunReportItem[]`](#persistence-type-sha256-5cfb152f36311f78fafa82bd4d218a48923871799877025d02ece8f58a2b3e38) |
| `resultPreview` | 可选 | `string` |
| `resumable` | 可选 | `true` |
| `resumedFrom` | 可选 | `string` |
| `runId` | 必需 | `string` |
| `status` | 必需 | [`DynamicRunStatus`](#persistence-type-sha256-ba169af277f766b371fbdd04ac89ef738d32b871772bc5226c4bdd0a67183b29) |
| `stopReason` | 可选 | [`union (5 variants)`](#persistence-type-sha256-654290a5c09a69d3a673c077b1d050d545804a2ab18e77ff765597bae32c860a) |
| `supersededBy` | 可选 | `string` |
| `truncated` | 可选 | `boolean` |
| `usage` | 可选 | [`{ durationMs?, totalTokens? }`](#persistence-type-sha256-efca909786cba73d9c1f9bfdfd16fc8c490f5d5522f76d0f3d4693d48672a453) |
...
来源：[`packages/workflow/workflow-runs/src/dynamic.ts:9`](../packages/workflow/workflow-runs/src/dynamic.ts)
...
来源：[`packages/workflow/workflow-runs/src/dynamic.ts:57`](../packages/workflow/workflow-runs/src/dynamic.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| `bytes` | 可选 | `number` |
| `contentType` | 可选 | `string` |
| `description` | 可选 | `string` |
| `id` | 必需 | `string` |
| `itemCount` | 可选 | `number` |
| `kind` | 必需 | `string` |
| `preset` | 可选 | [`{ entries, kind, spec }`](#persistence-type-sha256-70c60755786643df197e1cfe1945ad05fe587a27f4d2fff091c0ac26b7738d16) |
| `primary` | 可选 | `true` |
| `title` | 可选 | `string` |
| `version` | 必需 | `number` |
...
[`DynamicWorkflowRunArtifact`](#persistence-type-sha256-64d6a4cf958c37f57d9ef9da741a5e1a893fc35ab1378ef8974330e489c8b584) 的数组。
...
来源：[`packages/workflow/workflow-runs/src/dynamic.ts:36`](../packages/workflow/workflow-runs/src/dynamic.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| `code` | 必需 | `string` |
| `message` | 必需 | `string` |
| `providerStop` | 可选 | [`DynamicWorkflowRunProviderStop`](#persistence-type-sha256-3054823532f2c6d049fc596618d5b620076025e3500f05192dbd34a26d4e9bd6) |
...
来源：[`packages/workflow/workflow-runs/src/dynamic.ts:44`](../packages/workflow/workflow-runs/src/dynamic.ts)
...
[`DynamicWorkflowRunPendingQuestion`](#persistence-type-sha256-161c9f9c4ddcf93fff0c4c63a93ca2f6abdad0946bc3b90ee15d6ff046834a5d) 的数组。
...
来源：[`packages/workflow/workflow-runs/src/dynamic.ts:21`](../packages/workflow/workflow-runs/src/dynamic.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| `kind` | 必需 | [`union (6 variants)`](#persistence-type-sha256-8b4826693358cd8b862430875435fa369b3fca0e1f581c05e4c82a5530f3ec58) |
| `modelId` | 可选 | `string` |
| `phase` | 可选 | `string` |
| `providerCode` | 可选 | `string` |
| `providerId` | 可选 | `string` |
| `providerLabel` | 可选 | `string` |
| `rawMessage` | 可选 | `string` |
| `reason` | 必需 | `string` |
| `resetAt` | 可选 | `number` |
| `subagent` | 可选 | `string` |
| `subagentName` | 可选 | `string` |
...
来源：[`packages/workflow/workflow-runs/src/dynamic.ts:85`](../packages/workflow/workflow-runs/src/dynamic.ts)
...
[`DynamicWorkflowRunReportItem`](#persistence-type-sha256-fc362d6c3bc744ee54ea7e008f30aff28f240db9d9882faec31b12982b643d5c) 的数组。
...
来源：[`packages/workflow/workflow-runs/src/projection.ts:180`](../packages/workflow/workflow-runs/src/projection.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| `artifacts` | 可选 | [`WorkflowArtifact[]`](#persistence-type-sha256-bea709170af44f61fa4340342399232138a3712e45284ce4386dc38edc177e1c) |
| `currentPhase` | 可选 | `string` |
| `events` | 可选 | [`ProjectionEventLine[]`](#persistence-type-sha256-a868d71f167435e361014ba62ffaa8d9fea76bd6e7536ff11e1d65fdaed9b0a9) |
| `failure` | 可选 | [`{ kind, message }`](#persistence-type-sha256-b3fe674593fbca99d2c516712e325f28e8c8282b5897ca260b33fc6492920b14) |
| `jobId` | 可选 | `string` |
| `label` | 必需 | `string` |
| `nodes` | 可选 | [`ProjectionNode[]`](#persistence-type-sha256-f549d548639819706e391f1c45017f6a5c818678cab65523f5541dee47f5e876) |
| `pauseReason` | 可选 | `string` |
| `phaseOrder` | 可选 | [`string[]`](#persistence-type-sha256-93c33d9687613293f8c95d46c4d922fe9ceae83b84c384beff5c3315abe005f2) |
| `phases` | 可选 | [`ProjectionPhase[]`](#persistence-type-sha256-ed19d7f9320253f6c99ccb39cd6ff32fd47660c9927a86d420d6006442a566d3) |
| `recoveryActions` | 可选 | [`string[]`](#persistence-type-sha256-93c33d9687613293f8c95d46c4d922fe9ceae83b84c384beff5c3315abe005f2) |
| `reportPreview` | 可选 | `string` |
| `resumable` | 可选 | `true` |
| `runId` | 必需 | `string` |
| `status` | 必需 | [`WorkflowRunStatus`](#persistence-type-sha256-c697873fb2930d84db7ceb9d4c5aabf0a6d1e4a9f72569acdcd01be6f8b9d0d5) |
| `task` | 可选 | `string` |
| `truncated` | 可选 | `boolean` |
...
来源：[`packages/workflow/workflow-runs/src/projection.ts:65`](../packages/workflow/workflow-runs/src/projection.ts)
...
来源：[`packages/workflow/workflow-runs/src/projection.ts:58`](../packages/workflow/workflow-runs/src/projection.ts)
...
[`ProjectionEventLine`](#persistence-type-sha256-566f4b82a67804130d91689e3cfd57bed76860c50b9cea4b0b4ecd428f976388) 的数组。
...
来源：[`packages/workflow/workflow-runs/src/projection.ts:49`](../packages/workflow/workflow-runs/src/projection.ts)
...
| `label` | 必需 | `string` |
| `phase` | 可选 | `string` |
| `status` | 必需 | [`ProjectionRunStatus`](#persistence-type-sha256-510d00a990fcb0c258194e23d6d8653e4b27bb8c228b4c23d8d1b3c8ea4e65d3) |
...
[`ProjectionNode`](#persistence-type-sha256-b60803578c925a9a9f0bb7f77e61f3a4a159d1193558e7b680eaef681cc461d7) 的数组。
...
来源：[`packages/workflow/workflow-runs/src/projection.ts:172`](../packages/workflow/workflow-runs/src/projection.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| `artifactPath` | 可选 | `string` |
| `phase` | 必需 | `string` |
| `status` | 必需 | [`WorkflowNodeStatus`](#persistence-type-sha256-f6d4f4ff1348f5d265ee97933113c0c3a5e82712485a02128a10b68c2eb31e9f) |
| `title` | 可选 | `string` |
...
[`ProjectionPhase`](#persistence-type-sha256-b2307d848b6ed26c0b127aa155b085a69de0a2f35e3a2631023d1fe64f4111f8) 的数组。
...
来源：[`packages/workflow/workflow-runs/src/projection.ts:41`](../packages/workflow/workflow-runs/src/projection.ts)
...
来源：[`packages/workflow/workflow-runs/src/expert.ts:188`](../packages/workflow/workflow-runs/src/expert.ts)
...
[`WorkflowArtifact`](#persistence-type-sha256-ffc302e3e8bbae0395db76095e9b59063a93455de93b9cb3f01be93b40f05c7c) 的数组。
...
来源：[`packages/workflow/workflow-runs/src/expert.ts:37`](../packages/workflow/workflow-runs/src/expert.ts)
...
来源：[`packages/workflow/workflow-runs/src/expert.ts:25`](../packages/workflow/workflow-runs/src/expert.ts)
...
来源：[`packages/workflow/workflow-runs/src/projection.ts:148`](../packages/workflow/workflow-runs/src/projection.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| `durationMs` | 可选 | `number` |
| `totalTokens` | 可选 | `number` |
...
来源：[`packages/workflow/workflow-runs/src/dynamic.ts:75`](../packages/workflow/workflow-runs/src/dynamic.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| `entries` | 必需 | [`unknown[]`](#persistence-type-sha256-b1664fa89f8eab49a14e7e3168d8bc4da4aa9fd76332f6c4a053d839e5276ae7) |
| `kind` | 必需 | [`union (4 variants)`](#persistence-type-sha256-4c126a1b20263350b8caedb7dc8af9f1e05a00cd0e1062ba4d2ca4b2230b7d67) |
| `spec` | 必需 | `unknown`（不透明） |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `kind` | 必需 | [`union (11 variants)`](#persistence-type-sha256-b8e6bd75a6a177dcd859cbdfbc1d106161245a608e6cd487b9d1df35f3d4c74a) |
| `message` | 必需 | `string` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`ExpertRunProjectionEvent`](#persistence-type-sha256-d31a957c99857309baacc26e727c68cd7d12b1d571124333022b28ee75b48b83) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
| `type` | 必需 | `"expert-run/updated"` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`DynamicRunProjectionEvent`](#persistence-type-sha256-a56a10b920a783a356108a52a7d34afc9f2a8605d8cf9145a1a00e1f03a6043b) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
| `type` | 必需 | `"journal-run/updated"` |
