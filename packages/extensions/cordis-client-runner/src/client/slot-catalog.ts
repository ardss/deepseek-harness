...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    keyDomain: 'fixed by the owner\'s key table { [Kind in ChatNodeKind]: { node: ChatNode<Kind> } }, already taken: assistant-step, command, command-input, compaction, context, expert-workflow-run, journal-workflow-run, manual-compaction, model-retry, steering, system-prompt, tool-call, turn-error, turn-max-tokens, turn-process, turn-tail, turn-trigger, unknown, user, workflow-run',
    ...
    occupants: [
      ...
      'client-ui-workflow-run WorkflowProjectionPanel key \'journal-workflow-run\'',
      'client-ui-workflow-run WorkflowProjectionPanel key \'expert-workflow-run\'',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-workflow-run-detail WorkflowRunSidePane',
    ],
    replaceRisk: 'none',
  ...
  {
    key: 'workflow-run.detail.artifact',
    kind: 'keyed',
    scope: 'session',
    summary: 'One artifact preset body, dispatched by the preset kind.',
    doc: 'One artifact preset body, dispatched by the preset kind.',
    registerOptions: [
      {
        name: 'key',
        requirement: 'required',
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'sidebar.right.pane.tab\' (client-ui-workflow-run-detail), so it exists while that entry is mounted',
    occupants: [
      'client-ui-workflow-artifacts WorkflowArtifactBody',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'workflow-run.detail.artifact\', () => ctx.slots.register(\n      { name: \'workflow-run.detail.artifact\', key: \'<one key the owner dispatches>\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-workflow-artifacts/src/client/contract.ts:13',
  },
]
/* jscpd:ignore-end */
