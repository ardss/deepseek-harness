...
/** The expert workflow runtime service. */
export class ExpertWorkflowRuntime {
  ...
  /**
 * The expert workflow runtime.start.
 ...
 */
  ...
  /**
 * The expert workflow runtime.start background.
 * @param options - the options argument.
 * @returns the computed result.
 */
  ...
  /**
 * The expert workflow runtime.resume.
 * @param options - the options argument.
 * @returns the computed result.
 */
  async resume(
  ...
  /**
 * The expert workflow runtime.status.
 * @param options - the options argument.
 * @returns the computed result.
 */
  ...
  /**
 * The expert workflow runtime.retry.
 * @param options - the options argument.
 * @returns the computed result.
 */
  ...
  /**
 * The expert workflow runtime.cancel.
 * @param options - the options argument.
 * @returns the computed result.
 */
  ...
  /**
 * The expert workflow runtime.list.
 * @param options - the options argument.
 * @returns the computed result.
 */
  ...
  /**
 * The expert workflow runtime.events.
 * @param options - the options argument.
 * @returns the computed result.
 */
