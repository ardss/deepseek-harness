...
/**
 * Parses the workflow graph seed.
 * @param response - the response argument.
 * @param defaultPhase - the defaultPhase argument.
...
/**
 * Handles the gate root seed nodes.
 * @param seed - the seed argument.
 * @param gateNodeId - the gateNodeId argument.
 * @returns the computed result.
 */
...
/**
 * Normalizes the workflow graph seed candidate.
