...
import type { ExpertWorkflowRunSnapshot, WorkflowPhaseDefinition } from '@deepseek-ai/dsh-workflow-runs'

/**
 * Seeds the graph from phase artifact.
...
/**
 * Handles the update node prompts from phase artifact.
 * @param ctx - the ctx argument.
 * @param snapshot - the snapshot argument.
 * @param definition - the definition argument.
 * @param response - the response argument.
