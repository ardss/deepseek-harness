...
/** Shape of the workflow node runner runtime. */
...
/**
 * Runs the workflow node.
 * @param snapshotAccess - the snapshotAccess argument.
 * @param node - the node argument.
 * @param options - the options argument.
 * @param maxAttempts - the maxAttempts argument.
