...
/** The workflow scheduler event log service. */
export class WorkflowSchedulerEventLog {
  ...
  /**
 * The workflow scheduler event log.timestamp.
 ...
 */
  ...
  /**
 * The workflow scheduler event log.append graph status.
 ...
 */
  ...
  /**
 * The workflow scheduler event log.append collection record.
 ...
 */
  ...
  /**
 * The workflow scheduler event log.append expansion records.
 * @param expansion - the expansion argument.
 * @param phase - the phase argument.
 * @param signal - the signal argument.
 * @param snapshot - the snapshot argument.
 */
  ...
  /**
 * The workflow scheduler event log.emit event.
