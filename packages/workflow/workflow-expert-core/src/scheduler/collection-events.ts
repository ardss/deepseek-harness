import type { WorkflowGraphCollection, WorkflowRunSnapshot } from '@deepseek-ai/dsh-workflow-runs'
...
/**
 * Handles the emit expansion events.
 ...
 * @param runtime - the runtime argument.
 */
...
/**
 * Handles the exhaust collection.
 * @param snapshot - the snapshot argument.
