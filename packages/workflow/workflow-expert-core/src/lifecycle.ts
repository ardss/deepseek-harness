...
/** Shape of the workflow graph node change. */
...
/** Shape of the workflow snapshot lifecycle result. */
...
/** Shape of the reconcile workflow snapshot for resume options. */
...
/** Shape of the cancel workflow snapshot options. */
export interface CancelWorkflowSnapshotOptions {
  reason?: string
  timestamp: string
}

/** Shape of the reopen workflow graph node options. */
...
/** Shape of the reopen workflow graph node result. */
...
/** Shape of the apply workflow graph seed options. */
export interface ApplyWorkflowGraphSeedOptions {
  phase?: string
  timestamp: string
}

/** Shape of the apply workflow graph seed result. */
...
/** Shape of the apply workflow node prompt updates options. */
export interface ApplyWorkflowNodePromptUpdatesOptions {
  phase: string
  timestamp: string
}

/** Shape of the apply workflow node prompt updates result. */
...
/**
 * Reconciles the workflow snapshot for resume.
...
/**
 * Reopens the workflow graph node.
 * @param snapshot - the snapshot argument.
 * @param options - the options argument.
 * @returns the computed result.
 */
...
/**
 * Applys the workflow graph seed.
 * @param snapshot - the snapshot argument.
...
/**
 * Applys the workflow node prompt updates.
 * @param snapshot - the snapshot argument.
 * @param updates - the updates argument.
 * @param options - the options argument.
 * @returns the computed result.
 */
