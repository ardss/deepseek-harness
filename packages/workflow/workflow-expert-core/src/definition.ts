...
/** The built_in_expert_workflow_kind value. */
export const BUILT_IN_EXPERT_WORKFLOW_KIND = 'expert'
/** The built_in_expert_workflow_definition_id value. */
export const BUILT_IN_EXPERT_WORKFLOW_DEFINITION_ID = 'expert'
/** The built_in_expert_workflow_definition_version value. */
export const BUILT_IN_EXPERT_WORKFLOW_DEFINITION_VERSION = '2'

/** The default_expert_workflow_strategy value. */
...
/**
 * Creates the expert workflow definition.
...
/**
 * Handles the workflow definition phase map.
